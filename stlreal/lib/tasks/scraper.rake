namespace :scraper do
  ...
  task scrape: :environment do
			...
			params = {
				...
				category_group: "RRRR",
				category: "RHFR",
				'location.city' =>  "USA-STL-CHM|USA-STL-EUR|USA-STL-SAH|USA-STL-SAP|USA-STL-ARN|USA-STL-FEN|USA-STL-PAC|USA-KAN-KAN",
			...
			result["postings"].each do |posting|
				...
				@post.neighborhood = posting["annotations"]["source_neighborhood"]
